...
function genJson(url) {
    ...
    dirPath = dirPath.replace(this.paths.templates, this.paths.examples)
...
function readTemplates() {
    ...
    genJson = genJson.bind({
        paths: {
            templates: pathTemplates,
            examples: pathExmaples
        }
    });
                ...
                fs.stat(file, function (err, stat) {
                    ...
                    if (stat && stat.isDirectory()) {
                        try {
                            ...
                            example_dir_path = example_dir_path.replace(pathTemplates, pathExmaples);
